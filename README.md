...
bashgit clone https://github.com/username/backtracking-python.git
cd backtracking-python
bashpython nqueens.py
python knights_tour.py
python knapsack.py

📊 Kompleksitas Algoritma
MasalahAlgoritmaWaktuRuangN-QueensBacktrackingO(N!)O(N²)Knight's TourBacktracking + WarnsdorffO(N²)O(N²)KnapsackRekursif / BacktrackingO(2ᴺ)O(N)
